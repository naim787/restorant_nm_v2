...
{#if checkoutData.length >= 1}
  <div class="drawer drawer-end ml-10">
    ...
    <div class="drawer-side">
      ...
      <ul class="menu bg-base-200 text-base-content h-full w-[90vw] md:w-[30vw] mt-15 bg-blue-500 border flex flex-col justify-center items-center over">
        ...
        <div class="w-full h-[60vh] bg-red-500 flex flex-col flex-wrap justify-start items-center overflow-scroll">
