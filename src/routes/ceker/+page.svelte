...
<div class="w-[100vw] h-[100vh] pt-15 px-2 bg-gray-900 text-white overflow-y-auto">
  ...
  <!-- filter -->
   <div class="w-full flex justify-evenly items-center gap-2 fixed left-0 bg-gray-900 p-2">
    <div class="font-bold w-[90px] h-[70px] p-2 rounded-md xl:rounded-2xl bg-black border-gray-400 flex items-center text-1xl"><AlarmClock class="text-blue-500"/> : {.length}</div>
