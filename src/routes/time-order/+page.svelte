        ...
        <Table hoverable={true} >
          ...
          <TableBody>
            <TableBodyRow class="bg-gray-600 text-white hover:bg-tranparent">
              ...
              <TableBodyCell>
                <Button onclick={() => (defaultModal = true)} class="text-yellow-600 dark:text-yellow-500 font-medium p-2 rounded-full bg-yellow-500/10 border border-yellow-500 hover:bg-">LIHAT</Button>
