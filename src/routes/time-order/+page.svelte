        ...
        <Table hoverable={true} >
          ...
          <TableBody>
            <TableBodyRow class="bg-gray-600 text-white hover:bg-tranparent">
              ...
              <TableBodyCell>
                <Button onclick={() => (defaultModal = true)} class="text-primary-600 dark:text-primary-500 font-medium hover:underline p-2 rounded-full bg-red-500/10 border border-red-500"></Button>
